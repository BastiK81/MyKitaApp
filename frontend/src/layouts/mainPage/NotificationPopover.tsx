...
import {NotificationCom} from "../../services/NotificationProfider";
...
export default function NotificationsPopover() {
    ...
    const {notifications, markAllAsRead, getUserNotifications} = useContext(NotificationCom);
